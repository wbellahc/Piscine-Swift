...
class ViewController: UIViewController, WKUIDelegate, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
       let url = URL(string: "https://api.intra.42.fr/oauth/authorize?client_id=43bbc6bc08f75bf4d46b6d47353eca2d71772a9eff69da0fbaa7f111c796e6db&redirect_uri=https%3A%2F%2Fwww.42.fr%2F&response_type=code&scope=public%20forum")
